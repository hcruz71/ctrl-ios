...
final class LanguageManager: ObservableObject {
    ...
    private let translations: [String: [String: String]] = [
        ...
        "gmail.error.reconnect_msg":       ["es": "Tu cuenta de Google necesita reconectarse para dar acceso a Gmail. Ve a Configuraciones → Google Calendar → desconecta tu cuenta y vuelve a conectarla aceptando todos los permisos.", "en": "Your Google account needs to reconnect to grant Gmail access. Go to Settings → Google Calendar → disconnect your account and reconnect accepting all permissions.", "pt": "Sua conta Google precisa se reconectar para conceder acesso ao Gmail. Vá em Configurações → Google Calendar → desconecte e reconecte aceitando todas as permissões.", "fr": "Votre compte Google doit se reconnecter pour accorder l'accès à Gmail. Allez dans Paramètres → Google Calendar → déconnectez et reconnectez en acceptant toutes les permissions.", "de": "Ihr Google-Konto muss erneut verbunden werden, um Gmail-Zugriff zu gewähren. Gehen Sie zu Einstellungen → Google Calendar → trennen und verbinden Sie erneut."],

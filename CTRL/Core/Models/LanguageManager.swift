...
final class LanguageManager: ObservableObject {
    ...
    private let translations: [String: [String: String]] = [
        ...
        "emails.period_week":          ["es": "1 semana",             "en": "1 week",                 "pt": "1 semana",                 "fr": "1 semaine",                "de": "1 Woche"],
        "emails.period_month":         ["es": "Último mes",           "en": "Last month",             "pt": "Último mês",               "fr": "Dernier mois",             "de": "Letzter Monat"],
        "emails.period_3months":       ["es": "Últimos 3 meses",     "en": "Last 3 months",          "pt": "Últimos 3 meses",          "fr": "3 derniers mois",          "de": "Letzte 3 Monate"],
        "emails.period_all":           ["es": "Todos los correos",   "en": "All emails",             "pt": "Todos os e-mails",         "fr": "Tous les e-mails",         "de": "Alle E-Mails"],
        ...
        "emails.importing_progress":   ["es": "Importando {imported} de {total} correos...",          "en": "Importing {imported} of {total} emails...",     "pt": "Importando {imported} de {total} e-mails...",      "fr": "Importation de {imported} sur {total} e-mails...",    "de": "{imported} von {total} E-Mails importieren..."],
        "emails.analyzing":            ["es": "Analizando correos...",                                "en": "Analyzing emails...",                           "pt": "Analisando e-mails...",                            "fr": "Analyse des e-mails...",                              "de": "E-Mails analysieren..."],
        "emails.analyzing_progress":   ["es": "Analizando {analyzed} de {total} correos...",          "en": "Analyzing {analyzed} of {total} emails...",     "pt": "Analisando {analyzed} de {total} e-mails...",      "fr": "Analyse de {analyzed} sur {total} e-mails...",        "de": "{analyzed} von {total} E-Mails analysieren..."],
        ...
        // Schedule
        "schedule.title":              ["es": "Horario",                      "en": "Schedule",                   "pt": "Horário",                  "fr": "Horaire",                  "de": "Zeitplan"],
        "schedule.current_mode":       ["es": "Modo actual",                  "en": "Current mode",               "pt": "Modo atual",               "fr": "Mode actuel",              "de": "Aktueller Modus"],
        "schedule.work_days":          ["es": "Días laborales",               "en": "Work days",                  "pt": "Dias de trabalho",         "fr": "Jours de travail",         "de": "Arbeitstage"],
        "schedule.work_hours":         ["es": "Horario laboral",              "en": "Work hours",                 "pt": "Horário de trabalho",      "fr": "Heures de travail",        "de": "Arbeitszeiten"],
        "schedule.start":              ["es": "Inicio",                       "en": "Start",                      "pt": "Início",                   "fr": "Début",                    "de": "Beginn"],
        "schedule.end":                ["es": "Fin",                          "en": "End",                        "pt": "Fim",                      "fr": "Fin",                      "de": "Ende"],
        "schedule.personal_time":      ["es": "Tiempo personal",              "en": "Personal time",              "pt": "Tempo pessoal",            "fr": "Temps personnel",          "de": "Persönliche Zeit"],
        "schedule.ends_at":            ["es": "Termina a las",                "en": "Ends at",                    "pt": "Termina às",               "fr": "Se termine à",             "de": "Endet um"],
        "schedule.personal_footer":    ["es": "Después de esta hora se activa el modo descanso", "en": "After this time rest mode activates", "pt": "Após este horário o modo descanso é ativado", "fr": "Après cette heure le mode repos s'active", "de": "Nach dieser Uhrzeit wird der Ruhemodus aktiviert"],
        "schedule.rest_message":       ["es": "Mensaje de descanso",          "en": "Rest message",               "pt": "Mensagem de descanso",     "fr": "Message de repos",         "de": "Ruhenachricht"],
        "schedule.rest_placeholder":   ["es": "Mensaje cuando es día libre",  "en": "Message for rest days",      "pt": "Mensagem para dias de folga", "fr": "Message pour les jours de repos", "de": "Nachricht für Ruhetage"],
        "schedule.rest_footer":        ["es": "Se muestra cuando el asistente detecta día de descanso", "en": "Shown when the assistant detects a rest day", "pt": "Exibido quando o assistente detecta dia de descanso", "fr": "Affiché quand l'assistant détecte un jour de repos", "de": "Wird angezeigt wenn der Assistent einen Ruhetag erkennt"],
        "schedule.save":               ["es": "Guardar horario",              "en": "Save schedule",              "pt": "Salvar horário",           "fr": "Enregistrer l'horaire",    "de": "Zeitplan speichern"],
        "schedule.saved":              ["es": "Horario guardado",             "en": "Schedule saved",             "pt": "Horário salvo",            "fr": "Horaire enregistré",       "de": "Zeitplan gespeichert"],
        "schedule.monday":             ["es": "Lunes",       "en": "Monday",      "pt": "Segunda",     "fr": "Lundi",       "de": "Montag"],
        "schedule.tuesday":            ["es": "Martes",      "en": "Tuesday",     "pt": "Terça",       "fr": "Mardi",       "de": "Dienstag"],
        "schedule.wednesday":          ["es": "Miércoles",   "en": "Wednesday",   "pt": "Quarta",      "fr": "Mercredi",    "de": "Mittwoch"],
        "schedule.thursday":           ["es": "Jueves",      "en": "Thursday",    "pt": "Quinta",      "fr": "Jeudi",       "de": "Donnerstag"],
        "schedule.friday":             ["es": "Viernes",     "en": "Friday",      "pt": "Sexta",       "fr": "Vendredi",    "de": "Freitag"],
        "schedule.saturday":           ["es": "Sábado",      "en": "Saturday",    "pt": "Sábado",      "fr": "Samedi",      "de": "Samstag"],
        "schedule.sunday":             ["es": "Domingo",     "en": "Sunday",      "pt": "Domingo",     "fr": "Dimanche",    "de": "Sonntag"],

        // Notification preferences
        "notif.title":                 ["es": "Notificaciones",               "en": "Notifications",              "pt": "Notificações",             "fr": "Notifications",            "de": "Benachrichtigungen"],
        "notif.enabled":               ["es": "Notificaciones activadas",     "en": "Notifications enabled",      "pt": "Notificações ativadas",    "fr": "Notifications activées",   "de": "Benachrichtigungen aktiviert"],
        "notif.status":                ["es": "Estado",                       "en": "Status",                     "pt": "Status",                   "fr": "Statut",                   "de": "Status"],
        "notif.status_active":         ["es": "Activas",                      "en": "Active",                     "pt": "Ativas",                   "fr": "Actives",                  "de": "Aktiv"],
        "notif.status_denied":         ["es": "Denegadas",                    "en": "Denied",                     "pt": "Negadas",                  "fr": "Refusées",                 "de": "Verweigert"],
        "notif.status_pending":        ["es": "Pendiente",                    "en": "Pending",                    "pt": "Pendente",                 "fr": "En attente",               "de": "Ausstehend"],
        "notif.activate":              ["es": "Activar notificaciones",       "en": "Enable notifications",       "pt": "Ativar notificações",      "fr": "Activer notifications",    "de": "Benachrichtigungen aktivieren"],
        "notif.open_settings":         ["es": "Abrir Ajustes para activar",   "en": "Open Settings to enable",    "pt": "Abrir Ajustes para ativar","fr": "Ouvrir Réglages",          "de": "Einstellungen öffnen"],
        "notif.section_tasks":         ["es": "Tareas",                       "en": "Tasks",                      "pt": "Tarefas",                  "fr": "Tâches",                   "de": "Aufgaben"],
        "notif.tasks_overdue":         ["es": "Tareas vencidas",              "en": "Overdue tasks",              "pt": "Tarefas vencidas",         "fr": "Tâches en retard",         "de": "Überfällige Aufgaben"],
        "notif.tasks_upcoming":        ["es": "Tareas próximas a vencer",     "en": "Tasks about to be due",      "pt": "Tarefas próximas do prazo","fr": "Tâches bientôt dues",      "de": "Bald fällige Aufgaben"],
        "notif.anticipation":          ["es": "Anticipación",                 "en": "Advance notice",             "pt": "Antecedência",             "fr": "Anticipation",             "de": "Vorlaufzeit"],
        "notif.inbox_reminder":        ["es": "Recordatorio de Inbox",        "en": "Inbox reminder",             "pt": "Lembrete da Caixa",        "fr": "Rappel Boîte de réception","de": "Posteingang-Erinnerung"],
        "notif.after":                 ["es": "Después de",                   "en": "After",                      "pt": "Depois de",                "fr": "Après",                    "de": "Nach"],
        "notif.section_delegations":   ["es": "Delegaciones",                 "en": "Delegations",                "pt": "Delegações",               "fr": "Délégations",              "de": "Delegierungen"],
        "notif.delegations_overdue":   ["es": "Delegaciones sin respuesta",   "en": "Unanswered delegations",     "pt": "Delegações sem resposta",  "fr": "Délégations sans réponse", "de": "Unbeantwortete Delegierungen"],
        "notif.day":                   ["es": "día",       "en": "day",       "pt": "dia",       "fr": "jour",      "de": "Tag"],
        "notif.days":                  ["es": "días",      "en": "days",      "pt": "dias",      "fr": "jours",     "de": "Tage"],
        "notif.week":                  ["es": "semana",    "en": "week",      "pt": "semana",    "fr": "semaine",   "de": "Woche"],
        "notif.1day":                  ["es": "1 día",     "en": "1 day",     "pt": "1 dia",     "fr": "1 jour",    "de": "1 Tag"],
        "notif.section_meetings":      ["es": "Reuniones",                    "en": "Meetings",                   "pt": "Reuniões",                 "fr": "Réunions",                 "de": "Besprechungen"],
        "notif.meetings_upcoming":     ["es": "Reuniones próximas",           "en": "Upcoming meetings",          "pt": "Reuniões próximas",        "fr": "Réunions à venir",         "de": "Anstehende Besprechungen"],
        "notif.section_summaries":     ["es": "Resúmenes",                    "en": "Summaries",                  "pt": "Resumos",                  "fr": "Résumés",                  "de": "Zusammenfassungen"],
        "notif.morning_summary":       ["es": "Resumen matutino",             "en": "Morning summary",            "pt": "Resumo matinal",           "fr": "Résumé du matin",          "de": "Morgenzusammenfassung"],
        "notif.weekly_review":         ["es": "Revisión semanal (viernes)",   "en": "Weekly review (Friday)",     "pt": "Revisão semanal (sexta)",  "fr": "Revue hebdomadaire (vendredi)", "de": "Wochenrückblick (Freitag)"],
        "notif.time":                  ["es": "Hora",      "en": "Time",      "pt": "Hora",      "fr": "Heure",     "de": "Uhrzeit"],
        "notif.saved":                 ["es": "Preferencias guardadas",       "en": "Preferences saved",          "pt": "Preferências salvas",      "fr": "Préférences enregistrées", "de": "Einstellungen gespeichert"],
